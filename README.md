...
It is not a wrapper around the X API. It is a small operator that knows three things the API does not tell you:
...
| `draft_check` | Score a draft (and variants) against the For You rules | free |
